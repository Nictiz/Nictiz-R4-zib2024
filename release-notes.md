...
### zib-VisualAcuity.VisualAcuityMeasurementDevice, nl-core-VisualAcuity.VisualAcuityMeasurementDevice
* `Device.type` ; terminology ; Changed Codes in VisualAcuityMeasurementDeviceCodelist ; ZIB-1412